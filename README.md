...
| 希望の確認、承認、相性・シゴデキ度によるおすすめ候補の表示 | 希望シフトの選択・提出 |
| 勤務時間・給与設定 | 勤務時間・給与・承認状況の確認 |
| 従業員別シフト表の確認、シゴデキ度の設定 | 一緒に働きやすさの登録 |
...
おすすめ候補は、従業員同士の相性平均と管理者が設定したシゴデキ度平均を比重付きで計算します。
